@extends('layouts.app', [
    'body_id' => 'home-page',
    'body_classes' => ['home1b', 'home-page', 'index-page'],
    'active_nav' => 'home',
])

@section('header')
    <div class="page-cover" style="background-image:url(/img/banner/home1b/design1.jpg)">
        <h1 class="title">Find Independent Design</h1>
        <p>
            <a class="btn btn-info" href="/designer/create" role="button">{{ strtoupper(trans('designer.create_a_designer_page')) }}</a>
            <a class="btn btn-success" href="/place/create" role="button">{{ strtoupper(trans('place.create_a_place_page')) }}</a>
        </p>
