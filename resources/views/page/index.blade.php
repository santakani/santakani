    ...
    <div class="carousel-cell" style="background-image:url(/storage/images/0/1/large.jpg)">
        <div class="jumbotron">
            <div class="container">
                ...
                <p>
                    <a class="btn btn-info btn-lg" href="#" role="button">Explore designer list</a>
                    <a class="btn btn-success btn-lg" href="#" role="button">Create designer profile</a>
                </p>
            </div><!-- .container -->
        </div><!-- .jumbotron -->
    </div><!-- .carousel-cell -->
    <div class="carousel-cell" style="background-image:url(/storage/images/0/2/large.jpg)">
        <div class="jumbotron">
            <div class="container">
                ...
                <p>This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                <p>
                    <a class="btn btn-info btn-lg" href="#" role="button">Open design map</a>
                    <a class="btn btn-success btn-lg" href="#" role="button">Mark a design shop</a>
                </p>
            </div><!-- .container -->
        </div><!-- .jumbotron -->
    </div><!-- .carousel-cell -->
    <div class="carousel-cell" style="background-image:url(/storage/images/0/3/large.jpg)">
        <div class="jumbotron">
            <div class="container">
                ...
                <p>This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                <p>
                    <a class="btn btn-info btn-lg" href="#" role="button">Start reading</a>
                    <a class="btn btn-success btn-lg" href="#" role="button">Write &amp; publish</a>
                </p>
            </div><!-- .container -->
        </div><!-- .jumbotron -->
    </div><!-- .carousel-cell -->
